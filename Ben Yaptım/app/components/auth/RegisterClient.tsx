...
const RegisterClient:React.FC<RegisterClientProps> = ({currentUser}) => {
    ...
    return (
        <AuthContainer>
            <div className="border w-[500px] p-3 shadow-lg rounded-md">
                ...
                <div className="text-center my-2 text-sm text-red-500">Giriş yapmak için <Link className="underline" href="/login">buraya</Link> tıklayın</div>
